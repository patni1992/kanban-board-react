const defaultState = {
  ...
  cards: {
    "1": { id: "1", title: `## Welcome to kanban-board in React
    `, color: "red" },
    "4": { id: "4",   title: `## Techonoliges used \n ![alt text](http://www.siamhtml.com/wp-content/uploads/2014/07/sass.png) 
    ...
    `, color: "green" },
    "2": { id: "2", title: `Cards support markup for more information see \n \n
    \n [**Markdown Cheatsheet**](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)`, color: "blue" },
    "3": { id: "3", title: ` * Move a card   
    \n * Create a card  
    \n * Move a list  
    \n * Create a list
    `, color: "orange" }
